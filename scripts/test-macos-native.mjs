...
assert.match(releaseInstall, /discover_server_url \|\| true/);
assert.match(releaseInstall, /Keep the polling loop alive under `set -e`/);
assert.match(releaseInstall, /--retry-connrefused/);
